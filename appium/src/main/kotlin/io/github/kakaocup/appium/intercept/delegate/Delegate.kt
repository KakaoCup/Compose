...
import io.github.kakaocup.appium.intercept.interaction.Interaction

/**
 * Base delegate interface for Kakao-Appium.
 *
...
interface Delegate<INTERACTION, ASSERTION, ACTION> : Interaction<ASSERTION, ACTION>
    ...
    private fun interceptOnCheck(
        interceptor: Interceptor<INTERACTION, ASSERTION, ACTION>,
        assertion: ASSERTION
    ): Boolean {
